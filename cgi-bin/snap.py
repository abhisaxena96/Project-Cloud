...
if  (a !="") and (b !="") :
	...
	print  "<html>"
	print  "<a href='http://192.168.26.128/clienttar/"+user+"_snap.tar' download>submit</a>"
	print  "</html>"
