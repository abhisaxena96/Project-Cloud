...
if (n=="1") and (a !="") and (b !="") :
	...
	print  "<html>"
	print  "<p><a href='http://192.168.26.128/clienttar/"+user+"_staas.tar' download>Downlode</a>tar file and run it</p>"
	print  "</html>"
...
#SSHFS--------------------------------------------------------------------    
	...
	commands.getoutput("sudo chmod 777 /media/"+user+" ") #"old is cloud now media "

	f1=open('/var/www/html/clienttar/staasclient.py','w+')
	f1.write("\nimport commands\ncommands.getoutput('yum install fuse-sshfs -y')\ncommands.getoutput('systemctl restart sshd')\ncommands.getoutput('mkdir /root/Desktop/"+user+" ')\ncommands.getoutput('sshfs "+user+"@192.168.26.128:/media/"+user + " /root/Desktop/"+user+" ')\n ")
	f1.close()
...
#ISCSI--------------------------------------------------------------------
	...
	f1.write("\nimport commands\ncommands.getoutput('iscsiadm --mode discoverydb --type sendtargets --portal 192.168.26.128 --discover')\ncommands.getoutput('iscsiadm --mode node --targetname "+user+" --portal 192.168.26.128:3260 --login')")
	f1.close()
	...
	print  "<html>"
	print  "<p><a href='http://192.168.26.128/clienttar/"+user+"_iscsi.tar' download>Downlode</a> tar file and run it.......</p>"
	print  "</html>"
	...
	print  "<html>"
	print  "<p><a href='http://192.168.26.128/clienttar/"+user+"_smb.tar' download>Downlode</a> tar file for linux user and run it</p>"
	print "<p>Windows users go to RUN window and type IP-->//192.168.26.128 and give username and password </p>"
	print  "</html>"
